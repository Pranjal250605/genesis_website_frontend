            ...
            <div className="group/track overflow-hidden mb-8">
                <div className="flex gap-6 w-max animate-marquee hover:[animation-play-state:paused]">
                    {[...collaborations, ...collaborations].map((src, i) => (
                        <div
                            key={i}
                            className="group relative flex-shrink-0 w-72 h-48 bg-white/[0.03] backdrop-blur-3xl rounded-[32px] border border-white/10 overflow-hidden transition-all duration-500 hover:border-amber-400/30 shadow-2xl"
                        >
                            <img
                                src={src}
