...
export default function OpenApplicationPage({ onNavigate }: OpenApplicationPageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Step 1: Upload CV to private bucket if provided
    if (cvFile) {
      ...
      if (uploadError) {
        ...
        setErrorMessage(t("open_application_page.error_upload"))
        return
      }
    ...
    if (error) {
      setSubmitStatus("error")
      setErrorMessage(t("open_application_page.error_submit"))
    } else {
      setSubmitStatus("success")
      setFormData({
        fullName: "", email: "", phone: "", location: "",
        linkedIn: "", portfolio: "", yearsOfExperience: "",
        expertise: "", motivation: "", availability: "",
      })
      setCvFile(null)
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-8 pt-32 pb-24">
        ...
        {submitStatus === "success" ? (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            className="rounded-[32px] border border-green-400/20 bg-green-400/[0.04] backdrop-blur-xl p-10 text-center"
          >
            <CheckCircle size={48} className="text-green-400 mx-auto mb-4" />
            <h3 className="text-white text-xl font-bold mb-2">{t("open_application_page.success_title")}</h3>
            <p className="text-white/50 text-[15px]">{t("open_application_page.success_body")}</p>
            <button
          ...
          >
            ...
            >
              <span>{submitStatus === "loading" ? t("open_application_page.submitting") : t("open_application_page.submit")}</span>
